                     ...
                     <div class="menu-menu-navigation-container">
                        <ul id="menu-menu-navigation" class="nav-menu menu-main-menu">
                           <li id="menu-item-511" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor menu-item-has-children no_group menu-item-511" data-depth="0">
                              <a href="#"><span class="menu-title">INTERNATIONAL CONFERENCE ON INTELLIGENT COMMUNICATION AND COMPUTATIONAL TECHNIQUES</span></a>
                  ...
                  <div class="pull-right">
                     <div class="woo-cart">
                        <div class="widget_cart_search_wrap">
                           ...
                           <div class="shopping_cart_dropdown">
                              ...
                              <a href="cart/index.html" class="btn btn-primary left wc-forward">31 March</a>
                              <span class="total right">Call for Papers <span><span class="woocommerce-Price-amount amount"> (Closed)</span></span></span>
                              <br>
                              <a href="cart/index.html" class="btn btn-primary left wc-forward">31 March</a>
                              <span class="total right">Call for Papers <span><span class="woocommerce-Price-amount amount"> (Closed)</span></span></span>
                              <br>
                     ...
                     <div class="menu-canvas">
                        ...
                        <nav class="main-canvas">
                           <div class="menu-menu-verticle-container">
                              <ul id="menu-menu-verticle" class="nav-menu menu-main-menu">
                                 ...
                                 <li id="menu-item-2816" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children no_group menu-item-2816" data-depth="0">
                                    ...
                                    <ul class='standar-dropdown standard autodrop_submenu sub-menu' style="width:200px;">
                                       ...
                                       <li id="menu-item-2831" class="menu-item menu-item-type-custom menu-item-object-custom no_group menu-item-2831" data-depth="1"><a href="index2cbf.html?p=2089777"><span class="menu-title">Track 3</span></a></li>
                                    </ul>
                                 </li>
