...
<html lang="en-US">
   <head>
      ...
      <link rel='stylesheet' id='wp-bolina-static-css'  href='themes/assets/css/static8a54.css?ver=1.0.0' type='text/css' media='all' />
                                             ...
                                             <div class="cms-fancyboxes-body">
                                                <div class="cms-fancybox-item">
                                                   <h3 class="facybox-title" style="
                                                      ...
                                                      color: ;
                                                      ">
                                                      WOOCOMMERCE                                            <span class="line-title" style="
                                                         background: #ffbf00;
                                                         width: 100px;
                                                         height: 3px;
                                                         margin: 20px auto 0;
                                                   ...
                                                   <div class="fancy-box-content" style="">
                                                      <p>The theme is fully integrated with the WooCommerce plugin so you can add your own store and sell anything you want.</p>
                                                   </div>
                                    ...
                                    <div class="vc_column-inner clearfix vc_custom_1440002723751">
                                       <div class="wrapper-content">
                                          <div class="row cms-fancyboxes-wraper template-cms_fancybox_single--layout2 content-align-default " id="cms-fancy-box-single-6"
                                             style="
                                             background-image: url(images/jaipur.jpg);background-size: cover;background-position: center top;background-repeat: no-repeat;
                                             min-height:438px;
                                             ">
                                             <div class="cms-fancyboxes-body">
                                                <div class="cms-fancybox-item">
                                             ...
                                             <div class="cms-fancyboxes-body">
                                                <div class="cms-fancybox-item">
                                                   <h3 class="facybox-title" style="
                                                      ...
                                                      color: ;
                                                      ">
                                                      TRANSLATION READY                                            <span class="line-title" style="
                                                         background: #ffbf00;
                                                         width: 100px;
                                                         height: 3px;
                                                         margin: 20px auto 0;
                                                   ...
                                                   <div class="fancy-box-content" style="">
                                                      <p>If you prefer a multilingual website, you can use the WPML plugin which is supported by Bolina. Language barrier is not a problem.</p>
                                                   </div>
                                                   <div class="cms-fancyboxes-foot">
                                                      <a href="#" class="text-link"
                                                         style="
                                             ...
                                             <div class="cms-fancyboxes-body">
                                                <div class="cms-fancybox-item">
                                                   <h3 class="facybox-title" style="
                                                      ...
                                                      color: ;
                                                      ">
                                                      UNLIMITED COLORS                                            <span class="line-title" style="
                                                         background: #ffbf00;
                                                         width: 100px;
                                                         height: 3px;
                                                         margin: 20px auto 0;
                                                   ...
                                                   <div class="fancy-box-content" style="">
                                                      <p>Flexible color to pick for your theme. Most of elements’ color can be changed easily in our live theme customizer.</p>
                                                   </div>
                                                   <div class="cms-fancyboxes-foot">
                                                      <a href="#" class="text-link"
                                                         style="
